...
option(ENABLE_MOT "enable mot in single_node mode,the old is --enable-mot" ON)
...
option(ENABLE_NVMDB "enable nvmdb in single_node mode" ON)
...
if(${ENABLE_LLVM_COMPILE} STREQUAL "ON")
    ...
    if(NOT ${LLVM_VERSION_STR} STREQUAL "")
...
if("${ENABLE_MOT}" STREQUAL "OFF" AND "${ENABLE_NVMDB}" STREQUAL "ON")
    message(FATAL_ERROR "error: --enable-nvmdb option must be used together with the --enable-mot option.")
endif()

if(NOT ${BUILD_TUPLE} STREQUAL "x86_64")
    if("${ENABLE_NVMDB}" STREQUAL "ON")
        message(FATAL_ERROR "error: --enable-nvmdb option supports x86-64 platform only right now.")
    endif()
endif()
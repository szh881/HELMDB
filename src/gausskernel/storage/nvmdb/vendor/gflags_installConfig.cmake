...
set(GFLAGS_LIB "${CMAKE_BINARY_DIR}/include/gflags/gflags.h")
...
if(NOT EXISTS "${GFLAGS_LIB}")
    ...
    execute_process(COMMAND ${CMAKE_COMMAND} -G "${CMAKE_GENERATOR}" -B build -DBUILD_SHARED_LIBS=ON -DBUILD_STATIC_LIBS=ON -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=${CMAKE_BINARY_DIR} -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER}

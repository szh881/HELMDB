...
PG_KEYWORD("attrs", ATTRS, UNRESERVED_KEYWORD)
...
PG_KEYWORD("dims", DIMS, UNRESERVED_KEYWORD)
...
PG_KEYWORD("documents", DOCUMENTS_P, UNRESERVED_KEYWORD)
...
PG_KEYWORD("graph", GRAPH_P, UNRESERVED_KEYWORD)
...
PG_KEYWORD("jsonarray", JSONARRAY, TYPE_FUNC_NAME_KEYWORD)
...
PG_KEYWORD("select_array", SELECT_ARRAY, RESERVED_KEYWORD)
...
PG_KEYWORD("toarray", TOARRAY, RESERVED_KEYWORD)
PG_KEYWORD("todoc", TODOC, RESERVED_KEYWORD)
PG_KEYWORD("tograph", TOGRAPH, RESERVED_KEYWORD)
PG_KEYWORD("totable", TOTABLE, RESERVED_KEYWORD)
...
PG_KEYWORD("unwind", UNWIND, UNRESERVED_KEYWORD)
...
PG_KEYWORD("vectors", VECTORS_P, UNRESERVED_KEYWORD)

...
/* vector index */
DATA(insert ( 75344   75285 75285 1 75307 ));

/* vector ivfflat index */
DATA(insert ( 75352   75285 75285 1 75308 ));
DATA(insert ( 75352   75285 75285 3 75292 ));
DATA(insert ( 75357   75285 75285 1 75309 ));
DATA(insert ( 75357   75285 75285 3 75310 ));
DATA(insert ( 75357   75285 75285 4 75297 ));
DATA(insert ( 75363   75285 75285 1 75309 ));
DATA(insert ( 75363   75285 75285 2 75297 ));
DATA(insert ( 75363   75285 75285 3 75310 ));
DATA(insert ( 75363   75285 75285 4 75297 ));
/* vector hnsw index */
DATA(insert ( 75370   75285 75285 1 75308 ));
DATA(insert ( 75374   75285 75285 1 75309 ));
DATA(insert ( 75378   75285 75285 1 75309 ));
DATA(insert ( 75378   75285 75285 2 75297 ));

...
/* Graph Index */
DECLARE_UNIQUE_INDEX(mm_graph_graphoid_index, 8811, on mm_graph using btree(graphoid oid_ops));
#define GraphOidIndexId 8811
DECLARE_UNIQUE_INDEX(mm_graphmeta_graphoid_index, 8821, on mm_graphmeta using btree(graphid oid_ops));
#define GraphmetaGraphOidIndexId 8821
DECLARE_UNIQUE_INDEX(mm_graphmeta_edgeid_index, 8822, on mm_graphmeta using btree(edgeid oid_ops));
#define GraphmetaEdgeLabelidIndexId 8822

/* Lable Index */
DECLARE_UNIQUE_INDEX(mm_label_labelid_index, 8841, on mm_label using btree(labelid oid_ops));
#define LabelidIndexId 8841
// DECLARE_UNIQUE_INDEX(mm_label_graphoid_index, 8842, on mm_label using btree(graphid oid_ops));
// #define GraphLabelOidIndexId 8842


/* Doc Index */
DECLARE_UNIQUE_INDEX(mm_documents_name_index, 9043, on mm_documents using btree(docsname name_ops));
#define MmDocsNameIndex	9043
DECLARE_UNIQUE_INDEX(mm_documents_id_index, 9044, on mm_documents using btree(docsid oid_ops));
#define MmDocsIdIndex	9044

/* Array Index */
DECLARE_UNIQUE_INDEX(mm_array_name_index, 9047, on mm_array using btree(arrname name_ops));
#define MmArrayNameIndex	9047
DECLARE_UNIQUE_INDEX(mm_array_id_index, 9048, on mm_array using btree(arrid oid_ops));
#define MmArrayIdIndex	9048


/* Vector Index */
DECLARE_UNIQUE_INDEX(mm_vector_name_index, 8865, on mm_vector using btree(vecname name_ops));
#define MmVectorNameIndex	8865
DECLARE_UNIQUE_INDEX(mm_vector_id_index, 8866, on mm_vector using btree(vecid oid_ops));
#define MmVectorIdIndex	8866

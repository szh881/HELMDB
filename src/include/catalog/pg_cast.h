 ...
 */
// vector -> vector
DATA(insert ( 75285 75285 75316 i f _null_));

// vector <-> real[]
DATA(insert ( 75285 1021 75321 i f _null_));
DATA(insert ( 1021 75285 75318 a f _null_));

// integer[] -> vector
DATA(insert ( 1007 75285 75317 a f _null_));

// double precision[] -> vector
DATA(insert ( 1022 75285 75319 a f _null_));

// numeric[] -> vector 
DATA(insert ( 1231 75285 75320 a f _null_));

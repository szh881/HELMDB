...
/* vector index */
DATA(insert OID = 75344 (403   vector_ops         PGNSP PGUID ));
/* hnsw index */
DATA(insert OID = 75370 (75343 vector_l2_ops      PGNSP PGUID ));
DATA(insert OID = 75374 (75343 vector_ip_ops      PGNSP PGUID ));
DATA(insert OID = 75378 (75343 vector_cosine_ops  PGNSP PGUID ));
/* ivfflat index */
DATA(insert OID = 75352 (75341 vector_l2_ops      PGNSP PGUID ));
DATA(insert OID = 75357 (75341 vector_ip_ops      PGNSP PGUID ));
DATA(insert OID = 75363 (75341 vector_cosine_ops  PGNSP PGUID ));
#endif   /* PG_OPFAMILY_H */

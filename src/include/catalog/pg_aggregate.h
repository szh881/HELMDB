...
#endif
DATA(insert ( 75314	vector_accum	vector_combine	vector_avg	0	1022	"{0}" "{0}" 	n	0));
#define VECTORAVGFUNCOID 75314
...
#endif
DATA(insert ( 75315	vector_add		vector_add		-				0	75285	_null_ _null_ 	n	0));
#define VECTORSUMFUNCOID 75315

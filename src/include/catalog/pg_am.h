...
/*vector index*/
// hnsw index
DATA(insert OID = 75343 (  hnsw		0 2 f t f f f t f f f f f 0 hnswinsert hnswbeginscan hnswgettuple - hnswrescan hnswendscan - - - hnswbuild hnswbuildempty hnswbulkdelete hnswvacuumcleanup - hnswcostestimate hnswoptions -));
DESCR("vector hnsw index access method");
#define HNSW_AM_OID 75343

// ivfflat index
DATA(insert OID = 75341 (  ivfflat		0 4 f t f f f t f f f f f 0 ivfflatinsert ivfflatbeginscan ivfflatgettuple - ivfflatrescan ivfflatendscan - - - ivfflatbuild ivfflatbuildempty ivfflatbulkdelete ivfflatvacuumcleanup - ivfflatcostestimate ivfflatoptions -));
DESCR("vector ivfflat index access method");
#define IVFFLAT_AM_OID 75341

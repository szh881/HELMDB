...
/* vector */
DATA(insert OID = 75285 ( vector         PGNSP PGUID -1 f b U f t \054 0 0 75291 vector_in vector_out vector_recv vector_send vector_typmod_in - - i x f 0 -1 0 0 _null_ _null_ _null_ ));
DESCR("Vector");
#define VECTOROID 75285
DATA(insert OID = 75291 ( _vector            PGNSP PGUID -1 f b A f t \054 0 75285 0 array_in array_out array_recv array_send vector_typmod_in - array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));

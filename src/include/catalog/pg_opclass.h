...
/* vector 
 * vector OID: 75285
 * vector array OID: 75291
 */
DATA(insert (403    vector_ops        PGNSP PGUID 75344 75285 t 0 ));
// hnsw
DATA(insert (75343  vector_l2_ops     PGNSP PGUID 75370 75285 f 0 ));
DATA(insert (75343  vector_ip_ops     PGNSP PGUID 75374 75285 f 0 ));
DATA(insert (75343  vector_cosine_ops PGNSP PGUID 75378 75285 f 0 ));
// ivfflat
DATA(insert (75341  vector_l2_ops     PGNSP PGUID 75352 75285 f 0 ));
DATA(insert (75341  vector_ip_ops     PGNSP PGUID 75357 75285 f 0 ));
DATA(insert (75341  vector_cosine_ops PGNSP PGUID 75363 75285 f 0 ));

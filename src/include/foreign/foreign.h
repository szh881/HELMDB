...
#define isNVMFromTblOid(relId) (OidIsValid(relId) && IsSpecifiedFDWFromRelid(relId, NVM_FDW))
#define isNVMTableFromSrvName(srvName) (IsSpecifiedFDW(srvName, NVM_FDW))
#endif /* FOREIGN_H */

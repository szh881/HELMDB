...
typedef struct ArrayScanPath{
    Path path;
} ArrayScanPath;

typedef struct DocumentScanPath{
    Path path;
} DocumentScanPath;

typedef struct VectorScanPath{
    Path path; 
} VectorScanPath;

typedef struct VectorIndexScanPath{
    IndexPath path;
} VectorIndexScanPath;

typedef struct GraphScanPath{
    Path path;
    List* cypher_rels;
    List* cypher_restrictexprlist;          /* RestrictInfo structures (if graph rel) */
} GraphScanPath;

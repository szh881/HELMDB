...
#include "catalog/mm_graphmeta.h"
...
const cachedesc cacheinfo[] = {
    ...
    {AccessMethodProcedureRelationId, /* AMPROCNUM */
        ...
        64},
    {ArrayRelationId, /* ARRAYID */
        MmArrayIdIndex,
        1,
        {Anum_mm_array_arrid, 0, 0, 0},
        8},
    {ArrayRelationId, /* ARRAYNAME */
        MmArrayNameIndex,
        1,
        {Anum_mm_array_arrname, 0, 0, 0},
        8},
    ...
    {PgDirectoryRelationId, /* DIRECTORYOID */
        ...
        {ObjectIdAttributeNumber, 0, 0, 0},
        64},
    {DocumentsRelationId, /* DOCSID */
        MmDocsIdIndex,
        1,
        {Anum_mm_documents_docsid, 0, 0, 0},
        8},
    {DocumentsRelationId, /* DOCSNAME */
        MmDocsNameIndex,
        1,
        {Anum_mm_documents_docsname, 0, 0, 0},
        8},
    ...
    {GraphRelationId, /* GRAPHOID */
        GraphOidIndexId,
        1,
        {Anum_mm_graph_graphoid, 0, 0, 0},
        16},
    {GraphMetaId, /* GRAPHMETAOID */
        GraphmetaGraphOidIndexId,
        1,
        {Anum_mm_graphmeta_graphid, 0, 0, 0},
        256},
    ...
    {IndexRelationId, /* INDEXRELID */
        ...
        1024},
    {LabelRelationId, /* LABELID */
        LabelidIndexId,
        1,
        {Anum_mm_label_labelid, 0, 0, 0},
        64},
    ...
    {UserStatusRelationId, /* USERSTATUSROLEID */
        ...
        128},
    {VectorRelationId, /* VECTORID */
        MmVectorIdIndex,
        1,
        {Anum_mm_vector_vecid, 0, 0, 0},
        8},

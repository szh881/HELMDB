...
#ifdef ENABLE_NVMDB
    } else if (!strcmp(funcname, "nvm_fdw_validator")) {
        retval = &nvm_fdw_validator;
    } else if (!strcmp(funcname, "nvm_fdw_handler")) {
        retval = &nvm_fdw_handler;
#endif
    }
...
#ifdef ENABLE_NVMDB
            strcmp(probinstring, "$libdir/nvm_fdw") &&
#endif

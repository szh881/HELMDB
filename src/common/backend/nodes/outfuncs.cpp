...
/*
 * Description: Write CypherMatchExpr struct to string.
 *
 * Parameters:
 *	@in node: CypherMatchExpr node.
 * 	@out str: CypherMatchExpr string.
 *
 * Return: void
 */
static void _outCypherMatchExpr(StringInfo str, const CypherMatchExpr* node)
{
    WRITE_NODE_TYPE("CYPHERMATCHEXPR");

    WRITE_NODE_FIELD(match_node_list);
    WRITE_NODE_FIELD(match_rel_list);
}
static void _outCypherStmt(StringInfo str, CypherStmt* node)
{
    WRITE_NODE_TYPE("CYPHERSTMT");

    WRITE_NODE_FIELD(match_pattern);
}
...
/*
 * Description: Write node RangeCypher to string.
 *
 * Parameters: @in node: RangeCypher node.
 *             @out str: RangeCypher string.
 *
 * Return: void
 */
static void _outRangeCypher(StringInfo str, RangeCypher* node)
{
    WRITE_NODE_TYPE("RANGECYPHER");

    WRITE_NODE_FIELD(relation);
    WRITE_NODE_FIELD(cypher_query);
    WRITE_NODE_FIELD(alias);
}

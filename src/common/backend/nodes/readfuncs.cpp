...
/*
 * Description: Read CypherMatchExpr string to CypherMatchExpr struct.
 *
 * Parameters: void
 *
 * Return: CypherMatchExpr*
 */
static CypherMatchExpr *_readCypherMatchExpr(void)
{
    READ_LOCALS(CypherMatchExpr);

    READ_NODE_FIELD(match_node_list);
    READ_NODE_FIELD(match_rel_list);

 ...
 *
 * Parameters:
 *	@in a: one RangeCypher
 *	@in b: another RangeCypher
 *
 * Return: bool (if a be equal to b return true, else return false)
 */
static bool _equalRangeCypher(const RangeCypher* a, const RangeCypher* b)
{
    COMPARE_NODE_FIELD(relation);
    COMPARE_NODE_FIELD(cypher_query);
    COMPARE_NODE_FIELD(alias);
    return true;
}

static bool _equalCypherStmt(const CypherStmt* a, const CypherStmt* b)
{
    COMPARE_NODE_FIELD(match_pattern);
 ...
 * Description: a compare with b
 *
 * Parameters: @in a: one CypherMatchExpr
 *             @in b: another CypherMatchExpr
 *
 * Return: bool (if a be equal to b return true, else return false)
 */
static bool _equalCypherMatchExpr(const CypherMatchExpr* a, const CypherMatchExpr* b)
{
    COMPARE_NODE_FIELD(match_node_list);
    COMPARE_NODE_FIELD(match_rel_list);
